...
contract Staker {
  ...
  //Staking deadline.  After this deadlinne, anyone send the funds to the other contract
  ...
  function execute() public {
    ...
    //(bool sent, bytes memory data) = exampleExternalContract.complete{value: contract:Balance}();
